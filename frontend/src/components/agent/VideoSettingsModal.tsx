...
export const VideoSettingsModal: React.FC<VideoSettingsModalProps> = ({ isOpen, onClose, jobId, onGenerate }) => {
                ...
                <SettingsSection>
                    ...
                    <SettingGroup>
                        ...
                        <div style={{ display: 'flex', gap: '10px', marginBottom: '15px' }}>
                            <Button primary={useGradient} onClick={() => setUseGradient(true)} style={{ padding: '8px' }}>
                                Gradient
                            </Button>
                            <Button primary={!useGradient} onClick={() => setUseGradient(false)} style={{ padding: '8px' }}>
                                Solid Color
                            </Button>
                        </div>
                        {!useGradient && (
                    ...
                    <SettingGroup>
                        ...
                        <PresetTokens>
                            {['#ffffff', '#f8f9fa', '#e9ecef', '#ffff00', '#00ffff'].map(c => (
                                <ColorToken key={c} color={c} onClick={() => setTextColor(c)} />
                            ))}
                        </PresetTokens>
                    </SettingGroup>
                    ...
                    <SettingGroup>
                        ...
                        <InputRow>
                            <input type="color" value={karaokeColor} onChange={e => setKaraokeColor(e.target.value)} />
                            <input type="text" value={karaokeColor} onChange={e => setKaraokeColor(e.target.value)} />
                        </InputRow>
                        <PresetTokens>
                            {['#ff0055', '#ff0000', '#00ff00', '#ffaa00', '#8a2be2'].map(c => (
                                <ColorToken key={c} color={c} onClick={() => setKaraokeColor(c)} />
                            ))}
                        </PresetTokens>
                    </SettingGroup>
